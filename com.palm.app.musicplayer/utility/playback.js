...
enyo.kind(
{
	...
	kind: "Component",
	components: [
		{name: "AudioManager", kind: "kindAudioManager", onPlaying: "onAudioPlaying", onEnded: "onEnded", onSrcChanged: "onAudioSrcChanged", onPausePlay: "doTrackPausePlay", onAudioError: "onAudioError"},
